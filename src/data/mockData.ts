...
export const floorMaps: FloorMap[] = [
  {
    ...
    zones: [
      zone("bk-0115", 9, 14, 13, 16), zone("bk-0118", 24, 14, 13, 16), zone("bk-0122", 39, 14, 13, 16),
      zone("bk-0132", 11, 45, 11, 14), zone("bk-0134", 24, 45, 11, 14), zone("bk-0136", 37, 45, 11, 14),
      zone("bk-0138", 50, 45, 11, 14), zone("bk-0150", 63, 45, 11, 14), zone("bk-0152", 76, 45, 11, 14),
      zone("bk-0154", 11, 65, 11, 14), zone("bk-0158", 28, 64, 34, 17),
    ],
  },
  {
    siteId: "brown-kopel",
